CREATE DATABASE [Vendors]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Vendors', FILENAME = N'C:\Vendors_projekt\Data\Vendors.mdf' , SIZE = 153600KB , FILEGROWTH = 12%), 
 FILEGROUP [SalesData] 
( NAME = N'SalesData', FILENAME = N'C:\Vendors_projekt\Data\SalesData.ndf' , SIZE = 153600KB , FILEGROWTH = 12%)
 LOG ON 
( NAME = N'Vendors_log', FILENAME = N'C:\Vendors_projekt\Data\Vendors_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
